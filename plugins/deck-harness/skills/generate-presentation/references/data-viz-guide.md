...
Chart-selection matrix, information-hierarchy principles, and visualization best practices.

**Who reads this**: `asset-curator` when generating a chart as inline SVG/HTML, and `design-director`
when a slide's pattern is a data slide. Apply the selection logic and design rules below directly.
