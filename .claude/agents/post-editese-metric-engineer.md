...
## 입력
- 기존 metrics.py: `plugins/humanize-korean/skills/humanize-korean/references/metrics.py`
- 기존 baseline.json: `plugins/humanize-korean/skills/humanize-korean/references/baseline.json`
- 기존 회귀 하네스: `plugins/humanize-korean/tests/run_tests.py`
